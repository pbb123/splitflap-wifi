...
W pliku (splitflap_example.mp4) znajduje się film pokazujący przykładowe użycie urządzenia.
...
* W sprzedaży jest kilka rodzajów małych płytek zawierających układ esp32-c3. Ja polecam konkretnie płytkę [waveshare esp32-c3 zero](https://www.waveshare.com/wiki/ESP32-C3-Zero), ponieważ posiada ona odizolowaną antenę i dzięki temu wifi działa na niej dużo lepiej w porównaniu z innymi płytkami.
